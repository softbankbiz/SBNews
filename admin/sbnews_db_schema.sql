...
# CREATE TABLE article_candidate (url VARCHAR(255) PRIMARY KEY, title VARCHAR(100) NOT NULL, ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP, created DATETIME, summary VARCHAR(924), category VARCHAR(80), class_name VARCHAR(40), confidence FLOAT(10), site_name VARCHAR(80), company_id VARCHAR(20) NOT NULL, news_id VARCHAR(100) NOT NULL);
