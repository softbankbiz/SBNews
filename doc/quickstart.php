...
<p>
	<b>Step_2　コンテンツ候補を取得</b><br>あらかじめ登録しておいた「ニュース取得開始日」「ニュース取得開始時刻」
...
<p>
	<b>Step_3　ニュース本文を作成</b><br>「連絡メモ欄（オプション）」に文字を入力すると、タイトル画像直下にお知らせメッセージを
...
<p>
	<b>Step_4　ランキングを作成</b><br>発行号を指定して記事のクリック数によるランキングを作成できます。なお、
	ランキングに含めたくないニュースが表示されている場合、右の「×」ボタンで削除できます。この場合、ランク外だった記事が
	繰り上がってランクインします。
</p>
<p>
	<b>Step_5　プレビューを確認</b><br>「プレビュー」ボタンをクリックしてニュースの実物を確認できます。修正が必要な場合は、
	前のステップに戻って修正を加え、再度「プレビュー」をクリックします。
</p>
<p>
	<b>Step_6　コンテンツを利用</b><br>修正が完了したら、プレビューされている件名と本文をそれぞれコピーして、
