...
<p>
	企業IDはWatson NLUのアカウントと1対1で紐づく、ニュース作成の基本単位となります。通常は1つの企業IDで運用を始めると思いますが、
	将来的に別部門や関連会社などが独自にWatson NLUのコストを負担して、独自にユースを作りたいとなった場合は、
...
<p>
	...
	管理者ユーザーはWatson NLUのモデルを作成し、クローラを設定し、新規にニュースを設定することを想定しています。
